...
public class RemoteViewStub extends RemoteView {
    ...
    public RemoteViewStub(String playerNickname, GameController controller, GameLobby lobby) {
        super(new SocketClientConnection(null, null), playerNickname, lobby, controller);
    }
